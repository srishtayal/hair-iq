  ...
  return (
    <section className="grid gap-8 md:grid-cols-2 md:gap-10">
      <SectionHeader
        ...
        title="India&apos;s largest hair patch wholesaler, now delivering directly to your doorstep"
        description="At Hair IQ, we&apos;ve been part of the hair patch industry for a long time and are India&apos;s largest trader."
      />
